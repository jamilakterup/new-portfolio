    ...
    return (
        <>
            <motion.div
                ...
                className={`${project.category == "All" ? "hidden" : "project-card"} cursor-pointer mix filter-class`}
            >
            ...
            {
                isOpen && <div className="fixed inset-0 z-50 bg-white/80 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 dark:bg-gray-950/80"> <div className="fixed left-[50%] top-[50%] z-50 grid w-full max-w-2xl translate-x-[-50%] translate-y-[-50%] gap-4 border border-gray-200 bg-white p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg md:w-full text-black">
                    ...
                    <div className="h-full max-h-max">
                        <img className="relative rounded-md w-full h-60 object-cover object-top hover:object-bottom duration-[3s] mt-4" src={modal.img} alt="" />
